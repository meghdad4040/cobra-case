					...
					<div className=' col-span-2 px-6 lg:px-0 lg:pt-4'>
						<div className=' relative mx-auto text-center lg:text-left flex flex-col items-center lg:items-start'>
							...
							<h1 className=' relative w-fit tracking-tight text-balance mt-16 font-bold !leading-tight text-gray-900 dark:text-gray-200 text-5xl md:text-6xl lg:text-7xl'>
								Your Image on a{" "}
								<span className=' bg-violet-600 px-2 text-white dark:bg-transparent dark:text-amber-300'>
									Custom
								</span>{" "}
								Phone Case
							</h1>
							<p className=' text-gray-600 dark:text-gray-200 mt-8 text-lg lg:pr-10 max-w-prose text-center lg:text-left text-balance md:text-wrap'>
								...
								phone case. CaseCobra allows you to protect your memories, not just
								your phone case.
							</p>
			...
			<section>
				<MaxWidthWrapper className='py-24'>
					...
					<ul className='mx-auto mt-12 max-w-prose sm:text-lg space-y-2 w-fit'>
						...
						<li className='w-fit'>
							<Check className='h-5 w-5 text-violet-600 inline mr-1.5' />5 year print
							warranty
						</li>
